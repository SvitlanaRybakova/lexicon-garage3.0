...
namespace lexicon_garage3.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
            ...
            IEmailSender emailSender)
        {
            ...
            _emailStore = (IUserEmailStore<Member>)GetEmailStore();
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _signInManager.SignInAsync((Member)user, isPersistent: false);
